...
const SelectLabel = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <SelectPrimitive.Label ref={ref as any} className={cn("py-1.5 pl-8 pr-2 text-sm font-semibold", className)} {...(props as any)} />
  )
);
...
const SelectSeparator = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <SelectPrimitive.Separator ref={ref as any} className={cn("-mx-1 my-1 h-px bg-muted", className)} {...(props as any)} />
  )
);
